...
from apps.customers.views import (
    ...
    professional_client_merge_confirm,
    professional_client_merge_dismiss,
    professional_client_merge_review,
...
urlpatterns = [
    ...
    path(
        "profesional/coincidencias/<int:professional_client_id>/<int:online_client_id>/",
        professional_client_merge_review,
        name="professional_client_merge_review",
    ),
    path(
        "profesional/coincidencias/<int:professional_client_id>/<int:online_client_id>/unificar/",
        professional_client_merge_confirm,
        name="professional_client_merge_confirm",
    ),
    path(
        "profesional/coincidencias/<int:professional_client_id>/<int:online_client_id>/separadas/",
        professional_client_merge_dismiss,
        name="professional_client_merge_dismiss",
    ),
