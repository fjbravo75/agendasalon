...
from apps.booking.views import (
    ...
    professional_holiday_appointment_acknowledge,
    professional_holiday_appointments,
...
urlpatterns = [
    ...
    path(
        "citas/festivos/",
        professional_holiday_appointments,
        name="professional_holiday_appointments",
    ),
    ...
    path(
        "citas/<int:appointment_id>/festivo/mantener/",
        professional_holiday_appointment_acknowledge,
        name="professional_holiday_appointment_acknowledge",
    ),
