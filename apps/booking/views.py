...
def _schedule_management_context(
    business,
    availability_form,
    closure_form,
    work_line_form,
    ...
    return {
        ...
        "editing_availability_label": (
            _weekday_label(editing_availability.weekday)
            if editing_availability is not None
            else ""
        ),
        "editing_closure": editing_closure,
        "editing_closure_label": (
            _closure_type_label(editing_closure.closure_type)
        ...
        "slot_interval_minutes": (
            calendar_settings.slot_interval_minutes
...
def _closure_type_label(closure_type):
