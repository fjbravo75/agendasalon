...
AGENDA_PLATFORM_CONTACT_EMAIL = os.environ.get(
    "AGENDA_PLATFORM_CONTACT_EMAIL",
    AGENDA_PLATFORM_PRIVACY_EMAIL,
)
AGENDA_PLATFORM_CONTACT_PHONE = os.environ.get(
...
AGENDA_DEMO_SUPERADMIN_PASSWORD = os.environ.get(
    "AGENDA_DEMO_SUPERADMIN_PASSWORD",
    "",
)
AGENDA_DEMO_MARI_PASSWORD = os.environ.get("AGENDA_DEMO_MARI_PASSWORD", "")
AGENDA_DEMO_NORTE_PASSWORD = os.environ.get("AGENDA_DEMO_NORTE_PASSWORD", "")
AGENDA_DEMO_REFRESH_RECOMMENDED_MAX_AGE_DAYS = 7
